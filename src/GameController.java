...
public class GameController {
    ...
    public void displayStartMenu() {
        ...
        DisplayString.mainMenuOptions();
        mainMenuInputHandle();
    }
    public void  mainMenuInputHandle(){
        while (true) {
    ...
    public void displayMenu() {
       DisplayString.secondaryMenuOptions(marketInsiderAttempts, player.getBalance());
    }
    ...
    public void predictNextMovement() {
        if (marketInsiderAttempts > 0) {
            ...
            if (player.getBalance() >= currentPrice) {
                DisplayString.blackMarketWarning(currentPrice);
                ...
                if (decision.equals("y")) {
                    ...
                    if (marketInsiderAttempts == 2) {
                        ...
                        DisplayString.caughtInAction(currentPrice);
    ...
    public void displayFinalResults() {
        ...
        if (finalBalance >= 3000000) {
            DisplayString.winningMessage();
        } else if (finalBalance >= 1000000) {
            DisplayString.noLossNoProfitMessage();
        } else {
         DisplayString.losingMessage();
        }
